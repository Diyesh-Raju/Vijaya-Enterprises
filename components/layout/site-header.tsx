 ...
 *
 * The home page is on the list because its walkthrough starts *below* the
 * bar rather than running behind it: there is white paper up there, not
 * film, so a transparent bar would leave the lockup on nothing. (For part
 * of 2026-09-16 the film ran up behind the bar and the home page was off
 * this list; the client asked for the white bar back, with the film
 * starting under it.)
 *
 * That is true of the walkthrough, and only of the walkthrough. A phone gets
 * `HomeHeroPhone` instead, and that band runs up behind the bar with a
      ...
      >
        <div className="container-page">
          {/* The row takes its height from `--header-h` less the hairline, so
              ...
              it — the home page's walkthrough, the handshake panel — and the
              scrim across the top of the phone's hero cannot drift out of
              register with it at any breakpoint or root font size. */}
