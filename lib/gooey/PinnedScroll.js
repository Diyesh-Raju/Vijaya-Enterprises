 ...
 * where the numbers now come from. The strip still lags the page a little,
 * which is what the demo's `damping` gave it and what the tiles take their
 * squash from: `Tile.update` measures its own scroll velocity, and a strip
 * that arrives instantly has none.
 */
...
export default class PinnedScroll {
    ...
    constructor({ track, content, ease = 0.18 }) {
        this.$track = track
