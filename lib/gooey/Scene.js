...
export default class Scene {
    ...
    constructor($scene, $root, Scroll) {
        ...
        // Capped at 2, where the demo took the device's ratio as it found it.
        // A 3× phone would otherwise be shading nine times the pixels of its
        // own screen for a full-window canvas, and past 2 the extra is finer
        // than the photographs it is drawing. The shaders take their pixel
        // resolution from this same number (`PR` in `Tile`), so the two
        // cannot drift apart.
